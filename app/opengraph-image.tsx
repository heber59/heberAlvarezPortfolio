  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", background: "#e7e5e4", padding: 58, fontFamily: "sans-serif" }}>
      <div style={{ display: "flex", width: "100%", height: "100%", borderRadius: 36, overflow: "hidden", boxShadow: "0 28px 80px rgba(42,35,25,.22)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: "50%", background: "#fffdf7", padding: 54, color: "#0f172a" }}><div style={{ fontSize: 34, lineHeight: 1.35 }}>React & TypeScript<br/>Design Systems<br/>Scalable User Experiences</div><div style={{ marginTop: 34, fontSize: 22, color: "#475569" }}>Backend Experience · AWS Certified</div></div>
      </div>
    </div>,
    size,
  );
